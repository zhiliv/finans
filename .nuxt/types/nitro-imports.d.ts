declare global {
  const DateNow: typeof import('D:/Projects/finans/server/utils/time')['DateNow']
  const __buildAssetsURL: typeof import('D:/Projects/finans/node_modules/nuxt/dist/core/runtime/nitro/paths')['buildAssetsURL']
  const __publicAssetsURL: typeof import('D:/Projects/finans/node_modules/nuxt/dist/core/runtime/nitro/paths')['publicAssetsURL']
  ...
  const cachedEventHandler: typeof import('D:/Projects/finans/node_modules/nitropack/dist/runtime')['cachedEventHandler']
  const cachedFunction: typeof import('D:/Projects/finans/node_modules/nitropack/dist/runtime')['cachedFunction']
  ...
  const defineAppConfig: typeof import('D:/Projects/finans/node_modules/nuxt/dist/core/runtime/nitro/config')['defineAppConfig']
  const defineAuthenticatedEventHandler: typeof import('D:/Projects/finans/server/utils/defineAuthenticatedEventHandler')['defineAuthenticatedEventHandler']
  const defineCachedEventHandler: typeof import('D:/Projects/finans/node_modules/nitropack/dist/runtime')['defineCachedEventHandler']
  const defineCachedFunction: typeof import('D:/Projects/finans/node_modules/nitropack/dist/runtime')['defineCachedFunction']
  const defineEventHandler: typeof import('h3')['defineEventHandler']
  const defineLazyEventHandler: typeof import('h3')['defineLazyEventHandler']
  const defineNitroPlugin: typeof import('D:/Projects/finans/node_modules/nitropack/dist/runtime')['defineNitroPlugin']
  ...
  const defineRenderHandler: typeof import('D:/Projects/finans/node_modules/nitropack/dist/runtime')['defineRenderHandler']
  ...
  const getAuth: typeof import('D:/Projects/finans/server/utils/getAuth')['default']
  const getCookie: typeof import('h3')['getCookie']
  const getCountTable: typeof import('D:/Projects/finans/server/utils/helper')['getCountTable']
  const getErrorResponse: typeof import('D:/Projects/finans/server/utils/helper')['getErrorResponse']
  const getHashPassword: typeof import('D:/Projects/finans/server/utils/access')['getHashPassword']
  const getHeader: typeof import('h3')['getHeader']
  const getHeaders: typeof import('h3')['getHeaders']
  const getList: typeof import('D:/Projects/finans/server/utils/helper')['getList']
  ...
  const getRouteRules: typeof import('D:/Projects/finans/node_modules/nitropack/dist/runtime')['getRouteRules']
  const getRouterParam: typeof import('h3')['getRouterParam']
  const getRouterParams: typeof import('h3')['getRouterParams']
  const getSalt: typeof import('D:/Projects/finans/server/utils/access')['getSalt']
  const getSession: typeof import('h3')['getSession']
  const getWhere: typeof import('D:/Projects/finans/server/utils/helper')['getWhere']
  ...
  const nitroPlugin: typeof import('D:/Projects/finans/node_modules/nitropack/dist/runtime')['nitroPlugin']
  ...
  const updateItem: typeof import('D:/Projects/finans/server/utils/helper')['updateItem']
  const updateSession: typeof import('h3')['updateSession']
  const useAppConfig: typeof import('D:/Projects/finans/node_modules/nitropack/dist/runtime')['useAppConfig']
  const useBase: typeof import('h3')['useBase']
  const useFiles: typeof import('D:/Projects/finans/server/utils/useFiles.js')['default']
  const useNitroApp: typeof import('D:/Projects/finans/node_modules/nitropack/dist/runtime')['useNitroApp']
  const useRuntimeConfig: typeof import('D:/Projects/finans/node_modules/nitropack/dist/runtime')['useRuntimeConfig']
  const useSession: typeof import('h3')['useSession']
  const useStorage: typeof import('D:/Projects/finans/node_modules/nitropack/dist/runtime')['useStorage']
  const writeEarlyHints: typeof import('h3')['writeEarlyHints']
}
export { defineCachedFunction, defineCachedEventHandler, cachedFunction, cachedEventHandler, useRuntimeConfig, useStorage, useNitroApp, defineNitroPlugin, nitroPlugin, defineRenderHandler, getRouteRules, useAppConfig } from 'D:/Projects/finans/node_modules/nitropack/dist/runtime';
