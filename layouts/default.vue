  ...
  data() {
    return {
      ...
      menu: [
        ...
        { name: 'Справочники', dropdown: true, list: [{ name: 'Типы документов', href: '/guides/page_type_docs' }] },
      ], // меню
    }
  },
}
